...
from .metadata import ENDPOINTS
from .profile import paos, ecp
from .soap import parse_soap_enveloped_saml_artifact_resolve
...
from .saml import NAMEID_FORMAT_ENTITY
from .response import LogoutResponse, ManageNameIDResponse, ArtifactResponse as RArtifactResponse
from .time_util import instant
from .s_utils import sid
from .s_utils import UnravelError
from .s_utils import error_status_factory
from .s_utils import rndstr
from .s_utils import success_status_factory
from .s_utils import decode_base64_and_inflate
from .s_utils import UnsupportedBinding
from .samlp import AuthnRequest, AuthzDecisionQuery, AuthnQuery
from .samlp import AssertionIDRequest
from .samlp import ManageNameIDRequest
from .samlp import NameIDMappingRequest
from .samlp import artifact_resolve_from_string
from .samlp import ArtifactResolve
from .samlp import ArtifactResponse
from .samlp import Artifact
from .samlp import LogoutRequest
from .samlp import AttributeQuery
from .mdstore import destinations
from .config import config_factory
from .httpbase import HTTPBase
from .sigver import security_context, response_factory
from .sigver import pre_signature_part
from .sigver import signed_instance_factory
from .virtual_org import VirtualOrg
...
# --------------------------------------------------------------------------
    ...
    def parse_manage_name_id_request_response(self, string, 
        ...
        return self._parse_response(string, ManageNameIDResponse,
                                    "manage_name_id_service", binding)
    ...
    def parse_artifact_resolve_response(self, xmlstr):
        ...
        resp = self._parse_response(xmlstr, RArtifactResponse,
