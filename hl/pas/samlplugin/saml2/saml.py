...
#
from .validate import valid_ipv4, MustValueError
from .validate import valid_ipv6
from .validate import ShouldValueError
...
def name_id_type__from_string(xml_string):
    return create_class_from_xml_string(NameIDType_, xml_string)
...
def encrypted_element_type__from_string(xml_string):
    return create_class_from_xml_string(EncryptedElementType_, xml_string)
...
def encrypted_id_from_string(xml_string):
    return create_class_from_xml_string(EncryptedID, xml_string)
...
def issuer_from_string(xml_string):
    return create_class_from_xml_string(Issuer, xml_string)
...
def assertion_id_ref_from_string(xml_string):
    return create_class_from_xml_string(AssertionIDRef, xml_string)
...
def assertion_uri_ref_from_string(xml_string):
    return create_class_from_xml_string(AssertionURIRef, xml_string)
...
def subject_confirmation_data_type__from_string(xml_string):
    return create_class_from_xml_string(SubjectConfirmationDataType_,
                                              xml_string)
...
def key_info_confirmation_data_type__from_string(xml_string):
    return create_class_from_xml_string(KeyInfoConfirmationDataType_,
                                              xml_string)
...
def audience_from_string(xml_string):
    return create_class_from_xml_string(Audience, xml_string)
...
def one_time_use_type__from_string(xml_string):
    return create_class_from_xml_string(OneTimeUseType_, xml_string)
...
def proxy_restriction_type__from_string(xml_string):
    return create_class_from_xml_string(ProxyRestrictionType_, xml_string)
...
def encrypted_assertion_from_string(xml_string):
    return create_class_from_xml_string(EncryptedAssertion, xml_string)
...
def subject_locality_type__from_string(xml_string):
    return create_class_from_xml_string(SubjectLocalityType_, xml_string)
...
def authn_context_class_ref_from_string(xml_string):
    return create_class_from_xml_string(AuthnContextClassRef, xml_string)
...
def authn_context_decl_ref_from_string(xml_string):
    return create_class_from_xml_string(AuthnContextDeclRef, xml_string)
...
def authn_context_decl_from_string(xml_string):
    return create_class_from_xml_string(AuthnContextDecl, xml_string)
...
def authenticating_authority_from_string(xml_string):
    return create_class_from_xml_string(AuthenticatingAuthority,
                                              xml_string)
...
def decision_type__from_string(xml_string):
    return create_class_from_xml_string(DecisionType_, xml_string)
...
def action_type__from_string(xml_string):
    return create_class_from_xml_string(ActionType_, xml_string)
...
def attribute_value_from_string(xml_string):
    return create_class_from_xml_string(AttributeValue, xml_string)
...
def encrypted_attribute_from_string(xml_string):
    return create_class_from_xml_string(EncryptedAttribute, xml_string)
...
def base_id_from_string(xml_string):
    return create_class_from_xml_string(BaseID, xml_string)
...
def name_id_from_string(xml_string):
    return create_class_from_xml_string(NameID, xml_string)
...
def subject_confirmation_data_from_string(xml_string):
    return create_class_from_xml_string(SubjectConfirmationData,
                                              xml_string)
...
def condition_from_string(xml_string):
    return create_class_from_xml_string(Condition, xml_string)
...
def audience_restriction_type__from_string(xml_string):
    return create_class_from_xml_string(AudienceRestrictionType_,
                                              xml_string)
...
def one_time_use_from_string(xml_string):
    return create_class_from_xml_string(OneTimeUse, xml_string)
...
def proxy_restriction_from_string(xml_string):
    return create_class_from_xml_string(ProxyRestriction, xml_string)
...
def statement_from_string(xml_string):
    return create_class_from_xml_string(Statement, xml_string)
...
def subject_locality_from_string(xml_string):
    return create_class_from_xml_string(SubjectLocality, xml_string)
...
def authn_context_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnContextType_, xml_string)
...
def action_from_string(xml_string):
    return create_class_from_xml_string(Action, xml_string)
...
def attribute_type__from_string(xml_string):
    return create_class_from_xml_string(AttributeType_, xml_string)
...
def subject_confirmation_type__from_string(xml_string):
    return create_class_from_xml_string(SubjectConfirmationType_,
                                              xml_string)
...
def audience_restriction_from_string(xml_string):
    return create_class_from_xml_string(AudienceRestriction, xml_string)
...
def authn_context_from_string(xml_string):
    return create_class_from_xml_string(AuthnContext, xml_string)
...
def attribute_from_string(xml_string):
    return create_class_from_xml_string(Attribute, xml_string)
...
def subject_confirmation_from_string(xml_string):
    return create_class_from_xml_string(SubjectConfirmation, xml_string)
...
def conditions_type__from_string(xml_string):
    return create_class_from_xml_string(ConditionsType_, xml_string)
...
def authn_statement_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnStatementType_, xml_string)
...
def attribute_statement_type__from_string(xml_string):
    return create_class_from_xml_string(AttributeStatementType_,
                                              xml_string)
...
def subject_type__from_string(xml_string):
    return create_class_from_xml_string(SubjectType_, xml_string)
...
def conditions_from_string(xml_string):
    return create_class_from_xml_string(Conditions, xml_string)
...
def authn_statement_from_string(xml_string):
    return create_class_from_xml_string(AuthnStatement, xml_string)
...
def attribute_statement_from_string(xml_string):
    return create_class_from_xml_string(AttributeStatement, xml_string)
...
def subject_from_string(xml_string):
    return create_class_from_xml_string(Subject, xml_string)
...
def evidence_type__from_string(xml_string):
    return create_class_from_xml_string(EvidenceType_, xml_string)
...
def evidence_from_string(xml_string):
    return create_class_from_xml_string(Evidence, xml_string)
...
def authz_decision_statement_type__from_string(xml_string):
    return create_class_from_xml_string(AuthzDecisionStatementType_,
                                              xml_string)
...
def authz_decision_statement_from_string(xml_string):
    return create_class_from_xml_string(AuthzDecisionStatement,
                                              xml_string)
...
def assertion_type__from_string(xml_string):
    return create_class_from_xml_string(AssertionType_, xml_string)
...
def assertion_from_string(xml_string):
    return create_class_from_xml_string(Assertion, xml_string)
...
def advice_type__from_string(xml_string):
    return create_class_from_xml_string(AdviceType_, xml_string)
...
def advice_from_string(xml_string):
    return create_class_from_xml_string(Advice, xml_string)
