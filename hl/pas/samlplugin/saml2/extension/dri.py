...
from hl.pas.samlplugin.saml2.md import EntityIDType_
...
def creation_instant_from_string(xml_string):
    return create_class_from_xml_string(CreationInstant, xml_string)
...
def serial_number_from_string(xml_string):
    return create_class_from_xml_string(SerialNumber, xml_string)
...
def usage_policy_from_string(xml_string):
    return create_class_from_xml_string(UsagePolicy, xml_string)
...
def publisher_type__from_string(xml_string):
    return create_class_from_xml_string(PublisherType_, xml_string)


class RegistrationAuthority(EntityIDType_):
...
def registration_authority_from_string(xml_string):
    return create_class_from_xml_string(RegistrationAuthority, xml_string)
...
def registration_instant_from_string(xml_string):
    return create_class_from_xml_string(RegistrationInstant, xml_string)
...
def registration_policy_from_string(xml_string):
    return create_class_from_xml_string(RegistrationPolicy, xml_string)
...
def publisher_from_string(xml_string):
    return create_class_from_xml_string(Publisher, xml_string)
...
def registration_info_type__from_string(xml_string):
    return create_class_from_xml_string(RegistrationInfoType_, xml_string)
...
def publishers_type__from_string(xml_string):
    return create_class_from_xml_string(PublishersType_, xml_string)
...
def registration_info_from_string(xml_string):
    return create_class_from_xml_string(RegistrationInfo, xml_string)
...
def publishers_from_string(xml_string):
    return create_class_from_xml_string(Publishers, xml_string)
...
def document_info_type__from_string(xml_string):
    return create_class_from_xml_string(DocumentInfoType_, xml_string)
...
def document_info_from_string(xml_string):
    return create_class_from_xml_string(DocumentInfo, xml_string)
