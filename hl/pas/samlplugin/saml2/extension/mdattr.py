...
from hl.pas.samlplugin.saml2 import saml
...
def entity_attributes_type__from_string(xml_string):
    return create_class_from_xml_string(EntityAttributesType_, xml_string)
...
def entity_attributes_from_string(xml_string):
    return create_class_from_xml_string(EntityAttributes, xml_string)
