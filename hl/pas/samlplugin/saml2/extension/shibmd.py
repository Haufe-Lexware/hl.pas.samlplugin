...
from hl.pas.samlplugin.saml2.xmldsig import KeyInfo
...
def scope_from_string(xml_string):
    return create_class_from_xml_string(Scope, xml_string)
...
def key_authority_from_string(xml_string):
    return create_class_from_xml_string(KeyAuthority, xml_string)
