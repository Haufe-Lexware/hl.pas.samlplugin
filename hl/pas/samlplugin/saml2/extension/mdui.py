...
from hl.pas.samlplugin.saml2.md import LocalizedNameType_, LocalizedURIType_

NAMESPACE = 'urn:oasis:names:tc:SAML:metadata:ui'

class DisplayName(LocalizedNameType_):
...
def display_name_from_string(xml_string):
    return create_class_from_xml_string(DisplayName, xml_string)


class Description(LocalizedNameType_):
...
def description_from_string(xml_string):
    return create_class_from_xml_string(Description, xml_string)


class InformationURL(LocalizedURIType_):
...
def information_url_from_string(xml_string):
    return create_class_from_xml_string(InformationURL, xml_string)


class PrivacyStatementURL(LocalizedURIType_):
...
def privacy_statement_url_from_string(xml_string):
    return create_class_from_xml_string(PrivacyStatementURL, xml_string)
...
def list_of_strings__from_string(xml_string):
    return create_class_from_xml_string(ListOfStrings_, xml_string)
...
def keywords_type__from_string(xml_string):
    return create_class_from_xml_string(KeywordsType_, xml_string)
...
def logo_type__from_string(xml_string):
    return create_class_from_xml_string(LogoType_, xml_string)
...
def ip_hint_from_string(xml_string):
    return create_class_from_xml_string(IPHint, xml_string)
...
def domain_hint_from_string(xml_string):
    return create_class_from_xml_string(DomainHint, xml_string)
...
def geolocation_hint_from_string(xml_string):
    return create_class_from_xml_string(GeolocationHint, xml_string)
...
def keywords_from_string(xml_string):
    return create_class_from_xml_string(Keywords, xml_string)
...
def logo_from_string(xml_string):
    return create_class_from_xml_string(Logo, xml_string)
...
def disco_hints_type__from_string(xml_string):
    return create_class_from_xml_string(DiscoHintsType_, xml_string)
...
def ui_info_type__from_string(xml_string):
    return create_class_from_xml_string(UIInfoType_, xml_string)
...
def disco_hints_from_string(xml_string):
    return create_class_from_xml_string(DiscoHints, xml_string)
...
def ui_info_from_string(xml_string):
    return create_class_from_xml_string(UIInfo, xml_string)
