...
from hl.pas.samlplugin.saml2.saml import Issuer
from hl.pas.samlplugin.saml2.samlp import IDPList
#import soapenv as S
...
def request_type__from_string(xml_string):
    return create_class_from_xml_string(RequestType_, xml_string)
...
def relay_state_type__from_string(xml_string):
    return create_class_from_xml_string(RelayStateType_, xml_string)
...
def request_from_string(xml_string):
    return create_class_from_xml_string(Request, xml_string)
...
def relay_state_from_string(xml_string):
    return create_class_from_xml_string(RelayState, xml_string)
