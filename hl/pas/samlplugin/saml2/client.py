...
from .s_utils import status_message_factory
...
from .time_util import not_on_or_after
from .saml import AssertionIDRef
from .saml import NAMEID_FORMAT_PERSISTENT
from .client_base import Base
from .client_base import LogoutError
from .client_base import NoServiceDefined
...
class Saml2Client(Base):
    ...
    def prepare_for_authenticate(self, entityid=None, relay_state="",
                                 binding=BINDING_HTTP_REDIRECT, vorg="",
