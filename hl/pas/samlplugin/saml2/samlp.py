...
def status_detail_type__from_string(xml_string):
    return create_class_from_xml_string(StatusDetailType_, xml_string)
...
def authn_context_comparison_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnContextComparisonType_,
                                              xml_string)
...
def name_id_policy_type__from_string(xml_string):
    return create_class_from_xml_string(NameIDPolicyType_, xml_string)
...
def idp_entry_type__from_string(xml_string):
    return create_class_from_xml_string(IDPEntryType_, xml_string)
...
def artifact_from_string(xml_string):
    return create_class_from_xml_string(Artifact, xml_string)
...
def new_id_from_string(xml_string):
    return create_class_from_xml_string(NewID, xml_string)
...
def new_encrypted_id_from_string(xml_string):
    return create_class_from_xml_string(NewEncryptedID, xml_string)
...
def terminate_type__from_string(xml_string):
    return create_class_from_xml_string(TerminateType_, xml_string)
...
def assertion_id_request_type__from_string(xml_string):
    return create_class_from_xml_string(AssertionIDRequestType_,
                                              xml_string)
...
def requested_authn_context_type__from_string(xml_string):
    return create_class_from_xml_string(RequestedAuthnContextType_,
                                              xml_string)
...
def attribute_query_type__from_string(xml_string):
    return create_class_from_xml_string(AttributeQueryType_, xml_string)
...
def authz_decision_query_type__from_string(xml_string):
    return create_class_from_xml_string(AuthzDecisionQueryType_,
                                              xml_string)
...
def artifact_resolve_type__from_string(xml_string):
    return create_class_from_xml_string(ArtifactResolveType_, xml_string)
...
def logout_request_type__from_string(xml_string):
    return create_class_from_xml_string(LogoutRequestType_, xml_string)
...
def name_id_mapping_request_type__from_string(xml_string):
    return create_class_from_xml_string(NameIDMappingRequestType_,
                                              xml_string)
...
def idp_list_type__from_string(xml_string):
    return create_class_from_xml_string(IDPListType_, xml_string)
...
def artifact_resolve_from_string(xml_string):
    return create_class_from_xml_string(ArtifactResolve, xml_string)
...
def manage_name_id_request_type__from_string(xml_string):
    return create_class_from_xml_string(ManageNameIDRequestType_,
                                              xml_string)
...
def authn_query_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnQueryType_, xml_string)
...
def scoping_type__from_string(xml_string):
    return create_class_from_xml_string(ScopingType_, xml_string)
...
def authn_request_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnRequestType_, xml_string)
...
def status_type__from_string(xml_string):
    return create_class_from_xml_string(StatusType_, xml_string)
...
def status_response_type__from_string(xml_string):
    return create_class_from_xml_string(StatusResponseType_, xml_string)
...
def response_type__from_string(xml_string):
    return create_class_from_xml_string(ResponseType_, xml_string)
...
def artifact_response_type__from_string(xml_string):
    return create_class_from_xml_string(ArtifactResponseType_, xml_string)
...
def name_id_mapping_response_type__from_string(xml_string):
    return create_class_from_xml_string(NameIDMappingResponseType_,
                                              xml_string)
...
def artifact_response_from_string(xml_string):
    return create_class_from_xml_string(ArtifactResponse, xml_string)
...
def status_code_type__from_string(xml_string):
    return create_class_from_xml_string(StatusCodeType_, xml_string)
