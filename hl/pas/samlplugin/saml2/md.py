...
def entity_id_type__from_string(xml_string):
    return create_class_from_xml_string(EntityIDType_, xml_string)
...
def localized_name_type__from_string(xml_string):
    return create_class_from_xml_string(LocalizedNameType_, xml_string)
...
def localized_uri_type__from_string(xml_string):
    return create_class_from_xml_string(LocalizedURIType_, xml_string)
...
def extensions_type__from_string(xml_string):
    return create_class_from_xml_string(ExtensionsType_, xml_string)
...
def endpoint_type__from_string(xml_string):
    return create_class_from_xml_string(EndpointType_, xml_string)
...
def indexed_endpoint_type__from_string(xml_string):
    return create_class_from_xml_string(IndexedEndpointType_, xml_string)
...
def organization_display_name_from_string(xml_string):
    return create_class_from_xml_string(OrganizationDisplayName,
                                              xml_string)
...
def contact_type_type__from_string(xml_string):
    return create_class_from_xml_string(ContactTypeType_, xml_string)
...
def additional_metadata_location_type__from_string(xml_string):
    return create_class_from_xml_string(AdditionalMetadataLocationType_,
                                              xml_string)
...
def any_uri_list_type__from_string(xml_string):
    return create_class_from_xml_string(AnyURIListType_, xml_string)
...
def key_types__from_string(xml_string):
    return create_class_from_xml_string(KeyTypes_, xml_string)
...
def artifact_resolution_service_from_string(xml_string):
    return create_class_from_xml_string(ArtifactResolutionService,
                                              xml_string)
...
def assertion_id_request_service_from_string(xml_string):
    return create_class_from_xml_string(AssertionIDRequestService,
                                              xml_string)
...
def assertion_consumer_service_from_string(xml_string):
    return create_class_from_xml_string(AssertionConsumerService,
                                              xml_string)
...
def requested_attribute_type__from_string(xml_string):
    return create_class_from_xml_string(RequestedAttributeType_,
                                              xml_string)
...
def organization_type__from_string(xml_string):
    return create_class_from_xml_string(OrganizationType_, xml_string)
...
def contact_type__from_string(xml_string):
    return create_class_from_xml_string(ContactType_, xml_string)
...
def additional_metadata_location_from_string(xml_string):
    return create_class_from_xml_string(AdditionalMetadataLocation,
                                              xml_string)
...
def key_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(KeyDescriptorType_, xml_string)
...
def idpsso_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(IDPSSODescriptorType_, xml_string)
...
def attribute_consuming_service_type__from_string(xml_string):
    return create_class_from_xml_string(AttributeConsumingServiceType_,
                                              xml_string)
...
def authn_authority_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(AuthnAuthorityDescriptorType_,
                                              xml_string)
...
def pdp_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(PDPDescriptorType_, xml_string)
...
def attribute_authority_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(AttributeAuthorityDescriptorType_,
                                              xml_string)
...
def affiliation_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(AffiliationDescriptorType_,
                                              xml_string)
...
def attribute_consuming_service_from_string(xml_string):
    return create_class_from_xml_string(AttributeConsumingService,
                                              xml_string)
...
def authn_authority_descriptor_from_string(xml_string):
    return create_class_from_xml_string(AuthnAuthorityDescriptor,
                                              xml_string)
...
def spsso_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(SPSSODescriptorType_, xml_string)
...
def entity_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(EntityDescriptorType_, xml_string)
...
def entities_descriptor_type__from_string(xml_string):
    return create_class_from_xml_string(EntitiesDescriptorType_, xml_string)
