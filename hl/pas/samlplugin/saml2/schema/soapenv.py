...
def header__from_string(xml_string):
    return create_class_from_xml_string(Header_, xml_string)
...
def body__from_string(xml_string):
    return create_class_from_xml_string(Body_, xml_string)
...
def encoding_style__from_string(xml_string):
    return create_class_from_xml_string(EncodingStyle_, xml_string)
...
def fault_faultcode_from_string(xml_string):
    return create_class_from_xml_string(Fault_faultcode, xml_string)
...
def fault_faultstring_from_string(xml_string):
    return create_class_from_xml_string(Fault_faultstring, xml_string)
...
def fault_faultactor_from_string(xml_string):
    return create_class_from_xml_string(Fault_faultactor, xml_string)
...
def detail__from_string(xml_string):
    return create_class_from_xml_string(Detail_, xml_string)
...
def envelope__from_string(xml_string):
    return create_class_from_xml_string(Envelope_, xml_string)
...
def header_from_string(xml_string):
    return create_class_from_xml_string(Header, xml_string)
...
def body_from_string(xml_string):
    return create_class_from_xml_string(Body, xml_string)
...
def fault_detail_from_string(xml_string):
    return create_class_from_xml_string(Fault_detail, xml_string)
...
def fault__from_string(xml_string):
    return create_class_from_xml_string(Fault_, xml_string)
...
def envelope_from_string(xml_string):
    return create_class_from_xml_string(Envelope, xml_string)
...
def fault_from_string(xml_string):
    return create_class_from_xml_string(Fault, xml_string)
