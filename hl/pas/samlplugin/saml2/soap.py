...
from hl.pas.samlplugin.saml2 import create_class_from_element_tree
from hl.pas.samlplugin.saml2.samlp import NAMESPACE as SAMLP_NAMESPACE
from hl.pas.samlplugin.saml2.schema import soapenv
