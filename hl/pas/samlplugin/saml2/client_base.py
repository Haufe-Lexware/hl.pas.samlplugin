...
from .saml import NAMEID_FORMAT_TRANSIENT
from .saml import NAMEID_FORMAT_PERSISTENT
from .saml import NameID, Subject, Action, Evidence
from .samlp import AuthnQuery
from .samlp import NameIDMappingRequest
from .samlp import NameIDPolicy
from .samlp import AttributeQuery
from .samlp import AuthzDecisionQuery
from .samlp import AuthnRequest

import hl.pas.samlplugin.saml2.samlp
...
from .response import AuthzResponse
from .response import AssertionIDResponse
from .response import AuthnQueryResponse
from .response import NameIDMappingResponse
from .response import AuthnResponse

from hl.pas.samlplugin.saml2 import BINDING_HTTP_REDIRECT, BINDING_HTTP_POST, BINDING_PAOS, BINDING_SOAP, class_name
import logging

logger = logging.getLogger(__name__)

SSO_BINDING = BINDING_HTTP_REDIRECT
...
class Base(Entity):
    ...
    def create_authn_request(self, destination, vorg="", scoping=None,
        ...
        try:
            ...
            if nameid_format is None or \
                ...
                name_id_policy = NameIDPolicy(allow_create=allow_create,
    ...
    def create_attribute_query(self, destination, name_id=None,
        ...
        if name_id is None:
            if "subject_id" in kwargs:
                name_id = NameID(text=kwargs["subject_id"])
    ...
    def create_authz_decision_query_using_assertion(self, destination,
        ...
        return self.create_authz_decision_query(
            destination, _action, Evidence(assertion=assertion),
